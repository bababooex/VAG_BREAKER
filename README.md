# **VAG_BREAKER - arduino VW keyfob tool**
...
The x only means that it is encoding incorrectly, most Passats decode as type 1 but encode as type 2, probably missing key for encode type 1. All car examples are older types, not MQB with much harder security!
...
| Advanced screen 2 | Full key1 and key2 data directly, for complete debug via LCD |
